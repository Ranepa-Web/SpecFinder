...
const AppContent = () => {
    ...
    return (<Routes>
        ...
        <Route
            path="/create-vacancy"
            element={<PrivateRoute allowedUserTypes={[PROFILE_TYPES.EMPLOYER]}>
                <CreateVacancyForm/>
            </PrivateRoute>}
        />
        ...
        <Route
            ...
            element={<PrivateRoute allowedUserTypes={[PROFILE_TYPES.APPLICANT]}>
        ...
        <Route path="/resume/:id"
               element={<PrivateRoute allowedUserTypes={[PROFILE_TYPES.EMPLOYER]}><ResumePage/></PrivateRoute>}/>
